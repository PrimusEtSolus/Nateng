...
export default function BulkBuyerSignupPage() {
      ...
      <main className="flex-1 flex items-center justify-center px-4 pb-12">
        <div className="w-full max-w-lg bg-white rounded-[50px] p-8 md:p-12 shadow-xl">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl md:text-4xl font-semibold text-foreground">Bulk Buyer Sign Up</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-14 bg-teal-600 hover:bg-teal-700 text-white font-semibold text-xl rounded-full mt-8"
            >
              {isLoading ? "Creating account..." : "Sign Up as Bulk Buyer"}
            </Button>
          </form>

          <p className="text-center mt-6 text-foreground">
            Already have an account?{" "}
            <Link href="/login" className="underline font-medium hover:text-teal-600">
              Log In
            </Link>
          </p>
        </div>
