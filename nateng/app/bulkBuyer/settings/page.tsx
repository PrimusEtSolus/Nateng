...
export default function BulkBuyerSettingsPage() {
  ...
  const tabs = [
    ...
    { id: "seller", label: "Seller Settings", icon: MapPin },
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">Manage your bulk buyer account</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-colors ${
                  activeTab === tab.id ? "bg-teal-600 text-white" : "hover:bg-muted text-foreground"
                }`}
              >
        ...
        <div className="flex-1 max-w-2xl">
            ...
            <div className="bg-card rounded-2xl border border-border p-6">
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="bg-teal-600 hover:bg-teal-700 w-full h-12"
          ...
          <div className="flex justify-end mt-6">
            <Button 
              onClick={handleSave} 
              className="bg-teal-600 hover:bg-teal-700 px-8 h-12"
              disabled={isSaving}
            >
              {isSaving ? (
                <>
